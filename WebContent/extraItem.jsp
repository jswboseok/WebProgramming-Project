    ...
    <div id ="container">
        ...
        <div id ="contents">
			<table border="1" align="center" width="100%">
		        ...
		        rs.beforeFirst(); 
		         ...
		         %>
		            <tr>
		                ...
		                <% if(userID == null){%>
		               <td align="center"><a href="extraItem.jsp" onclick="alert('로그인 하세요')"><%=rs.getString("title") %></a></td>
      		...
      		<button type="button" onclick=" location.href='write.jsp'">글쓰기</button><!-- buy_write.jsp to write.jsp -->
