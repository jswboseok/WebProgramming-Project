...
<body>
    ...
    <div id ="container">
        ...
        <div class="table-wrapper">
		         ...
		         %>
		            <tr>
		               ...
		               <%-- <td align="center"><a href="board_read.jsp?id=<%=id%>""><%=rs.getString("title") %></a></td> --%>
		                <% if(userID == null){%>
		               <td><a class="detail_link" class="detail_link" href="clothes.jsp" onclick="alert('로그인을 먼저 해주세요.')"><%=rs.getString("title") %></a></td>
        	...
        	<% if(userID == null){%>
		     	<button class="write_button" ype="button" onclick="alert('로그인을 먼저 해주세요.')">글쓰기</button>
		     <%}else{%>
